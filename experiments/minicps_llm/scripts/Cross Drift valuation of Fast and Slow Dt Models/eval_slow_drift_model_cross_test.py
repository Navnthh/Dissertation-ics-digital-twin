# ═══════════════════════════════════════════════════════════════
# CROSS-EVALUATION — Slow Drift Model on Fast Drift Test Data
# (exact Colab code used, verbatim)
#
# NOTE: this cell assumes model_slow, tokenizer, series_summary(),
# and fmt() were already defined earlier in the same Colab session
# (model_slow = PeftModel loaded from
#  minicps_qwen_lora_ANSWER_ONLY_ULTRA). See
# eval_slow_drift_model_setup.py for the model-loading cell that
# must run first.
# ═══════════════════════════════════════════════════════════════
...
print(f"{'='*60}")
print(f"Fast model on fast drift:  100.0% accuracy")
print(f"Slow model on fast drift:  {accuracy:.1f}% accuracy")
print(f"Slow model on slow drift:  98.18% accuracy")

# ═══════════════════════════════════════════════════════════════
# ACTUAL COLAB OUTPUT:
#
# ============================================================
# SLOW DRIFT MODEL → FAST DRIFT TEST DATA (cross-test)
# ============================================================
# Testing: fast_run_009.csv
# Testing: fast_run_010.csv
#
# ============================================================
# CROSS-TEST RESULTS — Slow Model on Fast Drift Data
# ============================================================
# Total windows: 58
#   Attack: 22
#   Normal: 36
...
#
# Confusion Matrix:
#   TP: 22  TN: 0  FP: 36  FN: 0
#
# ============================================================
# FINAL COMPARISON SUMMARY
# ============================================================
# Fast model on fast drift:  100.0% accuracy
# Slow model on fast drift:  37.9% accuracy
# Slow model on slow drift:  98.18% accuracy
# ═══════════════════════════════════════════════════════════════
